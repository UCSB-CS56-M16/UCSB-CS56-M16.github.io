...
<li style="margin-bottom:3em;"> (5 pts) Under what circumstances should you use the == operator to compare two variables? 

</li>

<li style="margin-bottom:3em;"> (5 pts) Under what circumstances should you use the .equals method to compare two variables? 
<li>
