...
<tr>
<td>Make a </td><td style="border-bottom: 1px solid black; width:35%;">&nbsp;</td>
<td>of <code>JPanel</code>, and override one method:</td><td style="border-bottom: 1px solid black; width:35%;">&nbsp;</td>
</tr>
</table>
