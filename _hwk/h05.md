...
<tr>
<td style="text-align:right; width:35%">Make a </td><td style="border-bottom: 1px solid black; width:20%;">&nbsp;</td>
<td style="text-align:center; width:35%;">of <code>JPanel</code>, and override one method:</td><td style="border-bottom: 1px solid black; width:20%; text-align:left;">&nbsp;</td>
</tr>
</table>
