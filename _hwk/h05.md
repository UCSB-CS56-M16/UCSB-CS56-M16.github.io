...
(10 pts) The questions on this side continue with the discussion of the "mysterious method" started on the page 1.  

Though you can't call the mysterious method directly, there is a method that you *can* call that *asks* the system to call that method for you.  What is this method that you *can* call?
