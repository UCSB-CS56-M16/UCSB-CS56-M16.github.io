...
should be labelled (only the ones inside the boxes; not the ones from the "hand written notes").

(Note to grader: -2 for each mislabelled arrow, with a minimum grade of zero.)

<img src="hfdp_p23_90.png" alt="class diagram from HFDP p. 23" width="100%" />
