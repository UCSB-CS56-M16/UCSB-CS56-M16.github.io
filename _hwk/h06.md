...
<ul markdown="1" style="list-type-type:circle; color:orange;">
<li style="list-type-type:circle;"> print `The Box is checked!` if the box is checked </li>
<li style="list-type-type:circle;"> print `The Box is not checked!` if the box is unchecked.</li>
</ul>
