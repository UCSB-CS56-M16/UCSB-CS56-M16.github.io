...
![Heroku Dashboard Getting Started](HerokuDashboardWithGettingStarted.png)
...
| ![Navigate to Documentation](nav_to_documentation.png) |![Navigate to Java](nav_to_java.png) |
...
|                                                                      |                                                                                        |
|----------------------------------------------------------------------|----------------------------------------------------------------------------------------|
|![Smaller Java on Heroku](lower_size_nav_to_getting_started.png) |![Getting Started with Java on Heroku](GettingStartedWithJavaOnHeroku.png) |
...
![I Have Downloaded Toolbelt Button](IHaveDownloadedTheToolbelt.png)
...
-   -   Call it <tt>cs56-{{site.qtr|downcase}}-{{page.num}}</tt>.
    -   Make it public
...
![Empty Github Repo](emptyRepoGithub.png)
...
(2) Locate the "ssh" URL for that repo (e.g. something like `git@github.com:yourgithubid/cs56-`<tt>{{site.qtr|downcase}}-{{page.num}}</tt>`.git`) You are going to copy/paste that, so have that ready.
...
`git remote add github git@github.com:yourgithubid/`<tt>cs56-{{site.qtr|downcase}}-{{page.num}}</tt>`.git`
