...
-   -   Call it cs56-{{site.qtr|downcase}}-{{page.num}}.
    -   Make it public
...
(2) Locate the "ssh" URL for that repo (e.g. something like `git@github.com:yourgithubid/cs56-`{{site.qtr|downcase}}`-`{{page.num}}`.git`) You are going to copy/paste that, so have that ready.
